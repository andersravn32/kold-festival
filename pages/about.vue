...
<template>
  <section id="page-about" :class="{'overflow-y-hidden': sidebar.show}">
    <BlockContent />
  </section>
</template>

<style>
#page-about .block-header h2 {
  @apply text-white font-header text-6xl;
}

#page-about .block-container {
  @apply container mx-auto gap-8 my-8;
}
